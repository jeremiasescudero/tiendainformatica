...
import ServiciosBuscar from "../Servicios/serviciosBuscar";
import ServiciosListado from "../Servicios/serviciosListado";
import ServiciosRegistro from "../Servicios/serviciosRegistro";
...
function Servicios() {
    ...
    async function Buscar(_pagina) {
        ...
        const data = await ServiciosService.Buscar(ApellidoYNombre, _pagina);
    ...
    return (
        ...
        <div className="tituloPagina">
            Servicios <small>{TituloAccionABMC[AccionABMC]}</small>
        </div>
        ...
        {AccionABMC !== "L" && (
            <ServiciosRegistro {...{ AccionABMC, Item, Grabar, Volver }} />
        )}
        </div>
    );
    }
